...
def Inflated3DInceptionV3(input_shape=(20, 224, 224, 3), classes=1000):
    ...
    x = conv3d_bn(inputs, 32, 3, 3, 3, strides=(1, 2, 2), padding='valid')
    ...
    branch3x3 = conv3d_bn(x, 384, 3, 3, 3, strides=(1, 2, 2), padding='valid')

    branch3x3dbl = conv3d_bn(x, 64, 1, 1, 1)
    branch3x3dbl = conv3d_bn(branch3x3dbl, 96, 3, 3, 3)
    branch3x3dbl = conv3d_bn(branch3x3dbl, 96, 3, 3, 3, strides=(1, 2, 2), padding='valid')
    ...
    branch7x7 = conv3d_bn(branch7x7, 128, 1, 1, 7)
    branch7x7 = conv3d_bn(branch7x7, 192, 1, 7, 1)

    branch7x7dbl = conv3d_bn(x, 128, 1, 1, 1)
    branch7x7dbl = conv3d_bn(branch7x7dbl, 128, 1, 7, 1)
    branch7x7dbl = conv3d_bn(branch7x7dbl, 128, 1, 1, 7)
    branch7x7dbl = conv3d_bn(branch7x7dbl, 128, 1, 7, 1)
    branch7x7dbl = conv3d_bn(branch7x7dbl, 192, 1, 1, 7)
    ...
    branch7x7 = conv3d_bn(branch7x7, 192, 1, 1, 7)
    branch7x7 = conv3d_bn(branch7x7, 192, 1, 7, 1)
    ...
    branch3x3 = conv3d_bn(branch3x3, 320, 3, 3, 3, strides=(1, 2, 2), padding='valid')

    branch7x7x3 = conv3d_bn(x, 192, 1, 1, 1)
    branch7x7x3 = conv3d_bn(branch7x7x3, 192, 1, 1, 7)
    branch7x7x3 = conv3d_bn(branch7x7x3, 192, 1, 7, 1)
    branch7x7x3 = conv3d_bn(branch7x7x3, 192, 3, 3, 3, strides=(1, 2, 2), padding='valid')
    ...
    for i in range(2):
        ...
        branch3x3_1 = conv3d_bn(branch3x3, 384, 1, 1, 3)
        branch3x3_2 = conv3d_bn(branch3x3, 384, 1, 3, 1)
        ...
        branch3x3dbl_1 = conv3d_bn(branch3x3dbl, 384, 1, 1, 3)
        branch3x3dbl_2 = conv3d_bn(branch3x3dbl, 384, 1, 3, 1)
...
def conv3d_bn(x, filters, num_step, num_row, num_col, padding='same', strides=(1, 1, 1), name=None):
